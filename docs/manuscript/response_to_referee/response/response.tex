...
\textcolor{red}{TK: this section to be updated out once we have actually done the tests. I will work with Sofia to sort this out.}
...
\begin{itemize}
	...
	\item \textcolor{red}{TK: +real data results}
\end{itemize}
...
The text has been updated to remove the misleading separation between the two modulations.
	...
	\item \textit{Before Eq. (4), when talking about the coupling "in various complicated  
		...
		this is a likely explanation for the observed losses in coherence?  }
			...
			Regardless of the coupling mechanism, the time delay $\tau$ is the same; $\tau$ is the time delay due to the spatial propagation of the signal between the PEM position and the GW sensing apparatus. 
	...
	\textcolor{red}{TK: to discuss in person. See also point 18 below.}
	...
	Yes, the referee is correct to point out the potential for confusion through the current phrasing. We have rephrased these sentences to make it clear that the F-statistic maximises over $h_0, \phi_0, \iota$ and $\psi$, leaving a function of the remaining ``Doppler parameters".
	...
	\textcolor{red}{TK: To discuss in person. Also related to point 14.}
